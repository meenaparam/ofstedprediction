...
Note that none of the algorithms employed achieved an accuracy rate of over 57%. This indicates that other variables also contribute to the ultimate Ofsted grade schools receive and that future tuning and refining of the models is needed. This is particularly noticeable with the `naiveBayes` model, which tends to classify almost all input schools as Good. However, the variables and models included here do a decent job of explaining a reasonable amount of the variation in gradings. Three other algorithms were implemented but not used in the app because of lower accuracy rates than the four ultimately chosen.
